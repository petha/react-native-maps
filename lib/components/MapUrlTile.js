...
const propTypes = {
  ...
  /**
  * The extent of the tile set
  *
  * @platform ios
  */
  tileRect: PropTypes.object,

  /**
  * Alters canReplaceMapContent on IOS so that we can decide if we needs to render base map
  *
  * @platform ios
  */
  hidesMap: PropTypes.bool,
};
